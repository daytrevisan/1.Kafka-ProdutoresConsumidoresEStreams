...
class KafkaService<T> implements Closeable {
    ...
    KafkaService(String groupId, Pattern topic, ConsumerFunction parse, Class type) {
        this(parse, groupId, type);
        consumer.subscribe(Collections.singletonList(topic));
    }

    KafkaService(ConsumerFunction groupId, String topic, Class<T> parse) {
        this(parse, groupId, type);
    ...
    private Properties properties(Class<T> type, String groupId){
        ...
        properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, String.valueOf(type));
